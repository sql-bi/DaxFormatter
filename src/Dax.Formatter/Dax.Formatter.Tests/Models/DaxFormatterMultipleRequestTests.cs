namespace Dax.Formatter.Tests.Models
{
    ...
    public class DaxFormatterMultipleRequestTests
    {
        ...
        public void DaxFormatterMultipleRequest_MaxLineLenghtSerialization(DaxFormatterLineStyle lineStyle, int expectedLineStyle)
        {
            var request = new DaxFormatterMultipleRequest
            {
            ...
            var json = JsonSerializer.Serialize(request);
            var document = JsonDocument.Parse(json);
            var property = document.RootElement.GetProperty(nameof(DaxFormatterMultipleRequest.MaxLineLenght));
        ...
        public void DaxFormatterMultipleRequest_SkipSpaceAfterFunctionNameSerialization(DaxFormatterSpacingStyle spacingStyle, bool expectedSpacingStyle)
        {
            ...
            var json = JsonSerializer.Serialize(request);
            var document = JsonDocument.Parse(json);
            var property = document.RootElement.GetProperty(nameof(DaxFormatterMultipleRequest.SkipSpaceAfterFunctionName));
